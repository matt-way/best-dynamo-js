...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { KeyConditions: peg$parseKeyConditions };
  var peg$startRuleFunction = peg$parseKeyConditions;
  ...
  var peg$e7 = peg$literalExpectation("between", true);
  ...
  var peg$f1 = function(attribute, operator, values) {
      return {
        attribute: attribute,
        operator: operator,
        values: values
  ...
  var peg$f2 = function(operator, first, second) {
  ...
  function peg$parseKeyConditions() {
    var s0, s1, s2, s3, s4, s5, s6, s7;

    s0 = peg$currPos;
    s1 = peg$parseKeyCondition();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse_();
  ...
  function peg$parseKeyCondition() {
